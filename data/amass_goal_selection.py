...
SAVE_MOTIONS = True
OUT_DIR = Path("/home/jovyan/Metamotivo/data/goal_poses")
MOTION_FOLDER = Path("/home/jovyan/Metamotivo/data/humenv_amass")
ZERO_VELOCITY = True
if ZERO_VELOCITY:
...
TRAIN_DATASET = "/home/jovyan/Metamotivo/data/test_train_split/large1_small1_train_0.1.txt"
